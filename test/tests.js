...
describe('Type-Magic', function () {
    ...
    describe('Convert Method', function () {
        ...
        it("should convert string to date", function () {
            assert.strictEqual(convert.convert("2016-01-01T00:00:00Z", "date").toISOString(), (new Date("2016-01-01T00:00:00Z")).toISOString(), "Invalid Convert");
        });

        it("should convert string to date with format", function () {
            assert.strictEqual(convert.convert("20161202", "date", null, "YYYYMMDD").toISOString(), (new Date("2016-12-02T00:00:00Z")).toISOString(), "Invalid Convert");
        });
        ...
        it("should convert date to string", function () {
            assert.strictEqual(convert.convert(new Date("2016-01-01T00:00:00Z"), "string"), "2016-01-01T00:00:00.000Z", "Invalid Convert");
        });

        it("should convert date to string with format", function () {
            assert.strictEqual(convert.convert(new Date("2016-02-01T00:00:00Z"), "string", "YYYYMMDD"), "20160201", "Invalid Convert");
        });
        ...
        it("should convert number 0 to string with format", function () {
            assert.strictEqual(convert.convert(0.00, "string", "0000.00"), "0000.00", "Invalid Convert");
        });

        it("should convert number 0 to string", function () {
            assert.strictEqual(convert.convert(0.00, "string"), "0", "Invalid Convert");
        });
        ...
        it("should convert string to currency", function () {
            assert.strictEqual(convert.convert("R 1.20", "number"), 1.20, "Invalid Convert");
        });
        ...
        it("should convert array to string", function () {
            assert.strictEqual(convert.convert([{a: 1}, {a: 2}, {a: 3}], "string"), '{"a":1},{"a":2},{"a":3}', "Invalid Convert");
