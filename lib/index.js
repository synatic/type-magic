...
/**
 * @typedef {'string'|'boolean'|'date'|'number'|'integer'|'array'|'object'|'buffer'|'base64string'} TypeMagicType
 */

/**
 * @typedef {null|undefined|string|number|boolean|Date|Buffer|Array<unknown>|Object} TypeMagicValue
 */
...
class TypeMagic {
     ...
     *
     * @param {TypeMagicValue} val - the value to convert
     * @param {TypeMagicType} toType - target type name
     * @param {string} [format] - the format to user/convert to
     * @return {null|string|number|boolean|Date|Buffer|Array<unknown>|Object}
     */
     ...
     *
     * @param {TypeMagicValue} val - the value to validate can be converted
     * @param {TypeMagicType} toType - the type to be converted to
     * @param {BufferEncoding} [format] - the format to try
     * @return {null|boolean}
     */
     ...
     *
     * @param {TypeMagicValue} val - the value to force to a string
     * @param {BufferEncoding} [format] - format used by numeral/moment/stringify routines
     * @return {string|null}
     */
     ...
     *
     * @param {TypeMagicValue} val - the value to get the type name of
     * @return {null|TypeMagicType|'undefined'|'function'|'symbol'|'bigint'}
     */
    ...
    /**
     * Returns the check-types library
     * @return {typeof import('check-types')}
     */
    static get check() {
        return $check;
    }
 ...
 *
 * @param {null|TypeMagicType|'undefined'|'function'|'symbol'|'bigint'} fromType - the type to convert from
 * @param {TypeMagicType} toType - the type to convert to
 * @return {boolean}
 */
